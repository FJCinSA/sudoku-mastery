...
const P0 = [
  [5,0,0,6,0,0,9,0,2],[6,7,2,1,9,5,3,4,0],[0,9,8,0,4,0,0,6,0],
  [8,0,9,0,6,1,0,0,3],[0,2,0,8,0,3,7,0,0],[0,1,0,9,0,4,0,5,6],
  [0,6,0,5,0,7,0,0,4],[2,0,7,0,1,0,6,0,5],[0,4,0,2,0,6,0,7,0],
];
const P1 = [
